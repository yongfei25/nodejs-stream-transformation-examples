...
async function start() {
    ...
    const sourceBucket = s3SourceUrl.host
    const sourceKey = s3SourceUrl.pathname.slice(1)
    const tagetBucket = s3TargetUrl.host
    const targetKey = s3TargetUrl.pathname.slice(1)
